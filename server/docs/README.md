...
| **1** | Client ledger (เงินสดย่อย 1.1 / เงินทดรองจ่าย 1.2 / เคลียร์เงินทดรองจ่าย 1.3 / จ่ายเจ้าหนี้ภายนอก 1.4) | 🟡 Backend เสร็จ — **UI: 1.1✅ 1.2✅ 1.4✅ กำลังขึ้น 1.3** (ลำดับ 1.1→1.2→1.4→1.3) — แต่ละขั้นมี E2E test ถาวรใน `server/tests/*-ui.regression.js` |
