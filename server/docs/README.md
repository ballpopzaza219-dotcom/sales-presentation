...
ไล่อ่านทุกไฟล์ — อัปเดตล่าสุด: 2026-08-19
...
| **1** | Client ledger (เงินสดย่อย 1.1 / เงินทดรองจ่าย 1.2 / เคลียร์เงินทดรองจ่าย 1.3 / จ่ายเจ้าหนี้ภายนอก 1.4) | 🟡 Backend เสร็จ — **กำลังทำ UI** (ลำดับ 1.1→1.2→1.4→1.3) |
