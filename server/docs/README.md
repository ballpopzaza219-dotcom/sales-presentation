...
| หัวข้อ | เรื่อง | สถานะ |
|---|---|---|
| **4** | ใบขอซื้อ (PR) | ✅ **Backend + UI เสร็จครบ** (2026-08-21) — ลบหน้า demo-mode เดิมทิ้งทั้งหมด แทนที่ด้วย 3 หน้าจริง (รายการ/สร้าง/รายละเอียด) ต่อ API จริง รองรับทั้ง source='manual' และ source='boq' (พร้อมแสดงงบคงเหลือต่อบรรทัด BOQ) — E2E test ถาวร 27 checks ใน `server/tests/pr-ui.regression.js` |
| **1** | Client ledger (เงินสดย่อย 1.1 / เงินทดรองจ่าย 1.2 / เคลียร์เงินทดรองจ่าย 1.3 / จ่ายเจ้าหนี้ภายนอก 1.4) | ✅ **Backend + UI เสร็จครบทั้ง 1.1→1.2→1.4→1.3** (2026-08-21) — แต่ละขั้นมี E2E test ถาวรใน `server/tests/*-ui.regression.js` (รวม 167 checks เฉพาะ UI, บวก HTTP-level suite เดิมอีก 142 checks) |
